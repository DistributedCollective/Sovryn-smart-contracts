...
4. Once we have found this value, we simulate a sudden price drop of 10% on Bitcoin - as prescribed by the criterias discussed on the [SOV-4702](https://sovryn.atlassian.net/browse/SOV-4702?focusedCommentId=28611) Jira ticket's thread - by manipulationg the storage of the `CoinPairPrice` contract from Money On Chain oracle, in the slot 118 : `setStorageAt(CoinPairPriceAddress,118,currentPrice * 0.9);`. This action will also reflect a sudden price drop in the BPro asset.
