...
const { normalizeHardhatNetworkAccountsConfig, derivePrivateKeys } = require("hardhat/internal/core/providers/util");
...
function getAccountsPrivateKeysBuffer() {
	...
	return derivePrivateKeys(accountsConfig.mnemonic, accountsConfig.path, accountsConfig.initialIndex, accountsConfig.count);
}
