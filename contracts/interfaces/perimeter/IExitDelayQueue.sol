...
interface IExitDelayQueue {
    ...
    ///         request's originator, its owner, or its recorded receiver — never
    ///         widened when the owner has code, unlike delivery, because this call
    ///         names a destination. Requires the request Queued, unlocked, and the
    ///         queue not paused.
    ///
