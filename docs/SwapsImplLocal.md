...
- [internalExpectedReturn(address sourceTokenAddress, address destTokenAddress, uint256 sourceTokenAmount, address unused, IERC20[] defaultPath)](#internalexpectedreturn)
