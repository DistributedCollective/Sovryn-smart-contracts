# The common events for all modules (ModulesCommonEvents.sol)

View Source: [contracts/events/ModulesCommonEvents.sol](../contracts/events/ModulesCommonEvents.sol)
...
```js
event ProtocolModuleContractReplaced(address indexed prevModuleContractAddress, address indexed newModuleContractAddress, bytes32 indexed module);
```
