 ...
 *
 * Run:
 *   npx hardhat test tests/colfee/LenderExit.noReturnUnderlying.delay.test.js
 */
...
contract("ColFee delay — lender exit over a no-return (USDT-style) underlying", (accounts) => {
