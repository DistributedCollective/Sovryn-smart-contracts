...
import "./ColFeeLib.sol";

/// @title  ColFeeBorrowerExitOps
/// @notice Protocol-side ColFee borrower-exit charge hook: quotes the
...
contract ColFeeBorrowerExitOps is VaultController, IColFeeEvents {
    ...
    /// @param  surfaceId   ColFee surface key (borrower-withdraw).
    ...
    function escrowBorrowerExit(
        ...
        leg.queue = ColFeeLib.getExitDelayQueue();
