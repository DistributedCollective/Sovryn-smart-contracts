...
// now run the test:
//     npx hardhat test tests-onchain/sipSov3686.test.js --network rskForkedMainnet
...
describe("SIP-Sov3686 Test creation and execution", () => {
    ...
    it("SIP-Sov3686 is executable and valid", async () => {
            ...
            params: [
                {
                    forking: {
                        ...
                        blockNumber: 5937831, // block num at the time no new modules deployed yet
                    },
                },
            ],
        });
        ...
        await hre.run("sips:create", { argsFunc: "getArgsSov3686" });
        ...
        // VERIFY VestingRegistry has been upgraded
        ...
        expect(await vestingRegistry.getImplementation()).to.equal(
