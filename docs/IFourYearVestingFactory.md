...
View Source: [contracts/governance/Vesting/fouryear/IFourYearVestingFactory.sol](../contracts/governance/Vesting/fouryear/IFourYearVestingFactory.sol)
...
- [deployFourYearVesting(address _SOV, address _staking, address _tokenOwner, address _feeSharing, address _vestingOwnerMultisig, address _fourYearVestingLogic, uint256 _extendDurationFor)](#deployfouryearvesting)

---    

> ### deployFourYearVesting

⤿ Overridden Implementation(s): [FourYearVestingFactory.deployFourYearVesting](FourYearVestingFactory.md#deployfouryearvesting)
