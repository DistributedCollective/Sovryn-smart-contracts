...
describe("Protocol Modules Deployments and Upgrades via Governance", () => {
  ...
  describe("SIP-0076 Test creation and execution", () => {
      it("SIP-0076 is executable and valid", async () => {
          ...
          await hre.run("sips:create", { argsFunc: "getArgsSip0076" });
          ...
          expect(latestExchequerBalance.toString()).to.equal(previousExchequerBalance.add(ethers.BigNumber.from(ethers.utils.parseEther("9125500")).toString() ))
