 ...
 * (ILoanTokenLogicBeacon.sol)

View Source: [contracts/connectors/loantoken/LoanTokenLogicProxy.sol](../contracts/connectors/loantoken/LoanTokenLogicProxy.sol)

**↗ Extends: [AdvancedTokenStorage](AdvancedTokenStorage.md)**

## **ILoanTokenLogicBeacon** contract
