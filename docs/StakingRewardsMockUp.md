# Staking Rewards Contract MockUp (StakingRewardsMockUp.sol)

View Source: [contracts/mockup/StakingRewardsMockUp.sol](../contracts/mockup/StakingRewardsMockUp.sol)

**↗ Extends: [StakingRewards](StakingRewards.md)**
...
```js
contract BlockMockUp public blockMockUp;
