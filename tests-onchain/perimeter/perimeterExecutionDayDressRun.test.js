/**
 * Perimeter EXECUTION-DAY DRESS RUN — the activation rehearsed against a stack
 ...
 *
 * Gate: set PERIMETER_DRESS_RUN=TRUE (skipped otherwise — this spec is
...
const DRESS_RUN = process.env.PERIMETER_DRESS_RUN === "TRUE";

(DRESS_RUN ? describe : describe.skip)(
    "Perimeter execution-day dress run (live-deployed stack)",
    () => {
        ...
        it("executes both SIPs via governance, wires everything, charges live exits and leaves no-touch paths uncharged", async () => {
            ...
            // Its cycle is independent of the Perimeter parts and shorter, so on
