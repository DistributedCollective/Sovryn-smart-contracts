/**
 * VAULT_REVERT — fee-leg failure coverage on every ColFee transfer primitive.
 *
 ...
 *
 *   protocol tree (ColFeeBorrowerExitOps._payExitFeeLeg via delegatecall):
 ...
 *
 * Run:
 *   npx hardhat test tests/colfee/VaultRevert.feeleg.test.js
 */
...
contract("ColFee — VAULT_REVERT fee-leg failures (iToken tree)", (accounts) => {
...
contract("ColFee — VAULT_REVERT fee-leg failures (protocol tree)", (accounts) => {
    ...
    it("ERC20 fee leg returns false → withdrawCollateral pays FULL gross, ExitFeeSkipped(VAULT_REVERT)", async () => {
        ...
        // Fee transfers (ColFeeBorrowerExitOps._payExitFeeLeg ERC20 branch) return
