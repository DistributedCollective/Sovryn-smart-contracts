...
def main():
    ...
    brownie run scripts/contractInteraction/tasks/airdrop_distribution/airdrop_distribution_team.py --network testnet
    brownie run scripts/contractInteraction/tasks/airdrop_distribution/airdrop_distribution_team.py --network rsk-mainnet
    '''
    ...
    #'''
    vestingDistributionPath = './scripts/contractInteraction/tasks/airdrop_distribution/data/vestings-team-3y-23-06-test.csv'
    dryRun = False # False to execute, True to verify the file structure
