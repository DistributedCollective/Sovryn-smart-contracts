...
def updateLMConfig():
    ...
    MAX_ALLOCATION_POINT = 100000 * 1000 # 100 M
    # SOV/rBTC - 25k SOV
    ALLOCATION_POINT_BTC_SOV = 10000 # (WR)BTC/SOV

    # xUSD/rBTC - 1 SOV
    ALLOCATION_POINT_BTC_XUSD = 5000 # (WR)BTC/XUSD

    # DLLR/rBTC - 25k SOV
    ALLOCATION_POINT_BTC_DLLR =  20000 # (WR)BTC/DLLR
    ...
    data = lm.updateTokens.encode_input(
        [contracts['(WR)BTC/XUSD'],  contracts['(WR)BTC/SOV'], contracts['(WR)BTC/DLLR'], contracts['LiquidityMiningConfigToken']],
        [ALLOCATION_POINT_BTC_XUSD,  ALLOCATION_POINT_BTC_SOV, ALLOCATION_POINT_BTC_DLLR, ALLOCATION_POINT_CONFIG_TOKEN],
        True
    )
    tx = multisig.submitTransaction(lm.address,0,data)
    txId = tx.events["Submission"]["transactionId"]
