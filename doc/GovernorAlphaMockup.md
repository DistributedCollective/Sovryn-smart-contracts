# GovernorAlphaMockup.sol

View Source: [contracts/mockup/GovernorAlphaMockup.sol](../contracts/mockup/GovernorAlphaMockup.sol)

**↗ Extends: [GovernorAlpha](GovernorAlpha.md)**

**GovernorAlphaMockup**

## Functions

- [(address timelock*, address staking*, address guardian*, uint96 quorumVotes*, uint96 \_minPercentageVotes)](#)
