...
//		bool support;
	...
	function castVote(uint256 proposalId, uint option) public {
	...
	function _castVote(
		...
		proposal.votes[option] = add96(proposal.votes[option], votes, "GovernorAlpha::_castVote: vote overflow");
//		if (support) {
