...
contract("MultiSigKeyHolders:", (accounts) => {
    ...
    describe("addEthereumAddress", () => {
        ...
        it("Only owner should be able to add address", async () => {
            await expectRevert(
                multiSig.addEthereumAddress(account1, { from: account1 }),
                "unauthorized"
            );
        });
    ...
    describe("addEthereumAddresses", () => {
        ...
        it("Only owner should be able to add addresses", async () => {
            await expectRevert(
                multiSig.addEthereumAddresses([account1, account2], { from: account1 }),
                "unauthorized"
            );
        });
    ...
    describe("changeEthereumRequirement", () => {
        it("Only owner should be able to change ethereum requirement", async () => {
            await expectRevert(
                multiSig.changeEthereumRequirement(1, { from: account1 }),
                "unauthorized"
            );
        });
    ...
    describe("addBitcoinAddress", () => {
        ...
        it("Only owner should be able to add address", async () => {
            await expectRevert(
                multiSig.addBitcoinAddress(bitcoinAccount1, { from: account1 }),
                "unauthorized"
            );
        });
    ...
    describe("addBitcoinAddresses", () => {
        ...
        it("Only owner should be able to add addresses", async () => {
            await expectRevert(
                multiSig.addBitcoinAddresses([bitcoinAccount1, bitcoinAccount2], {
                    from: account1,
                }),
                "unauthorized"
            );
        ...
        /// @dev For test coverage
        it("Should be able to add redundant addresses, but ignored", async () => {
            let tx = await multiSig.addBitcoinAddresses([
                bitcoinAccount1,
                bitcoinAccount1,
                bitcoinAccount2,
            ]);
    ...
    describe("addEthereumAndBitcoinAddresses", () => {
        it("Shouldn't be able to add zero address", async () => {
            await expectRevert(
                multiSig.addEthereumAndBitcoinAddresses([ZERO_ADDRESS], [bitcoinAccount1]),
                "Invalid address"
            );
        });
        ...
        it("Only owner should be able to add address", async () => {
            await expectRevert(
                multiSig.addEthereumAndBitcoinAddresses(
                    [account1, account2],
                    [bitcoinAccount1, bitcoinAccount2],
                    { from: account1 }
                ),
                "unauthorized"
            );
        ...
        it("Should be able to add addresses", async () => {
            let tx = await multiSig.addEthereumAndBitcoinAddresses(
                [account1, account2],
                [bitcoinAccount1, bitcoinAccount2]
            );
    ...
    describe("removeEthereumAddress", () => {
        ...
        it("Only owner should be able to remove address", async () => {
            await expectRevert(
                multiSig.removeEthereumAddress(account1, { from: account1 }),
                "unauthorized"
            );
        });
    ...
    describe("removeEthereumAddresses", () => {
        it("Shouldn't be able to remove zero addresses", async () => {
            await expectRevert(
                multiSig.removeEthereumAddresses([ZERO_ADDRESS]),
                "Invalid address"
            );
        });
        ...
        it("Only owner should be remove to add addresses", async () => {
            await expectRevert(
                multiSig.removeEthereumAddresses([account1, account2], { from: account1 }),
                "unauthorized"
            );
        });
    ...
    describe("removeBitcoinAddress", () => {
        ...
        it("Only owner should be remove to add address", async () => {
            await expectRevert(
                multiSig.removeBitcoinAddress(bitcoinAccount1, { from: account1 }),
                "unauthorized"
            );
        });
    ...
    describe("removeBitcoinAddresses", () => {
        it("Shouldn't be able to remove zero addresses", async () => {
            await expectRevert(
                multiSig.removeBitcoinAddresses([EMPTY_ADDRESS]),
                "Invalid address"
            );
        });
        ...
        it("Only owner should be able to remove addresses", async () => {
            await expectRevert(
                multiSig.removeBitcoinAddresses([bitcoinAccount1, bitcoinAccount2], {
                    from: account1,
                }),
                "unauthorized"
            );
        ...
        it("Should be able to remove redundant addresses, just ignoring repeated ones", async () => {
            await multiSig.addBitcoinAddresses([bitcoinAccount1, bitcoinAccount2]);
            let tx = await multiSig.removeBitcoinAddresses([
                bitcoinAccount1,
                bitcoinAccount1,
                bitcoinAccount2,
            ]);
    ...
    describe("removeEthereumAndBitcoinAddresses", () => {
        it("Shouldn't be able to remove zero address", async () => {
            await expectRevert(
                multiSig.removeEthereumAndBitcoinAddresses([ZERO_ADDRESS], [bitcoinAccount1]),
                "Invalid address"
            );
        });
        ...
        it("Only owner should be able to remove address", async () => {
            await expectRevert(
                multiSig.removeEthereumAndBitcoinAddresses(
                    [account1, account2],
                    [bitcoinAccount1, bitcoinAccount2],
                    { from: account1 }
                ),
        ...
        it("Should be able to remove addresses", async () => {
            await multiSig.addEthereumAndBitcoinAddresses(
                [account1, account2],
                [bitcoinAccount1, bitcoinAccount2]
            );
            let tx = await multiSig.removeEthereumAndBitcoinAddresses(
                [account1, account2],
                [bitcoinAccount1, bitcoinAccount2]
            );
    ...
    describe("changeBitcoinRequirement", () => {
        it("Only owner should be able to change ethereum requirement", async () => {
            await expectRevert(
                multiSig.changeBitcoinRequirement(1, { from: account1 }),
                "unauthorized"
            );
        });
        ...
        it("Should be able to change ethereum requirement", async () => {
            let required = 3;
            await multiSig.addBitcoinAddresses([
                bitcoinAccount1,
                bitcoinAccount2,
                bitcoinAccount3,
            ]);
