# FeeSharingProxy contract. (FeeSharingProxy.sol)

View Source: [contracts/governance/FeeSharingProxy/FeeSharingProxy.sol](../contracts/governance/FeeSharingProxy/FeeSharingProxy.sol)

**↗ Extends: [FeeSharingProxyStorage](FeeSharingProxyStorage.md), [UpgradableProxy](UpgradableProxy.md)**

**FeeSharingProxy**

FeeSharingProxy contract should be upgradable, use UpgradableProxy.
