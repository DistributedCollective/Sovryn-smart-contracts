 ...
 *   6. queue pointer unset, ON         -> fail-CLOSED (`COLFEE:queue-unset`),
 ...
 *   8. delay-quote reverts             -> fail-CLOSED (`COLFEE:delay-quote-failed`),
 ...
 *
 * Run:
 *   npx hardhat test tests/colfee/BorrowerExit.delay.test.js
 */
...
contract("ColFee delay — borrower/margin exit reroute", (accounts) => {
    ...
    describe("fail-CLOSED behaviours", () => {
        it("perimeter ON but queue pointer unset -> reverts COLFEE:queue-unset (never pays direct)", async () => {
        ...
        it("delay quote reverts -> fail-CLOSED (COLFEE:delay-quote-failed), NOT treated as d=0", async () => {
            await armPerimeter();
