...
contract LoanTokenLogicDai is LoanTokenLogicStandard {
    ...
    // Kovan
    IChai public constant chai =
        IChai(0x71DD45d9579A499B58aa85F50E5E3B241Ca2d10d);
    ...
    function mintWithChai(address receiver, uint256 depositAmount)
        external
        nonReentrant
    ...
    function burnToChai(address receiver, uint256 burnAmount)
        external
        nonReentrant
    ...
    function _mintToken(
        ...
        require(
            inAsset.transferFrom(msg.sender, address(this), depositAmount),
            "18"
        );
    ...
    function _underlyingBalance() internal view returns (uint256) {
        return
            rmul(_getChai().balanceOf(address(this)), _rChaiPrice()).add(
                _getDai().balanceOf(address(this))
            );
    }
