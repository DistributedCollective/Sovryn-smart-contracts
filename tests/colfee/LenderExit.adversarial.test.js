 ...
 * ColFeeBorrowerExitOps delegatecall backstop; the iToken tree charges INLINE
 ...
 *
 * Run:
 *   npx hardhat test tests/colfee/LenderExit.adversarial.test.js
 */
...
contract("ColFee — lender-exit adversarial (iToken tree)", (accounts) => {
    ...
    async function fixture() {
        ...
        // ── ColFee controller, enabled at the 20 bps surface default ───────
    ...
    //         backstop — containment is the staticcall in ColFeeLib.safeQuote) ─
