...
///      IPerimeterEvents: a Solidity 0.5.17 `interface` can't inherit (added in
...
contract ILoanTokenModules is IPerimeterEvents {
    /** EVENT */
    ...
    /// Perimeter events are inherited from IPerimeterEvents.
