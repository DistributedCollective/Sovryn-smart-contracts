...
describe("Staking recovery dress rehearsal", () => {
    ...
    it("step 5: the proposal is created through GovernorAlpha", async () => {
        ...
        // exactly the shape getArgsSipStakingRecovery builds
        const targets = [STAKING, STAKING, STAKING, STAKING];
        ...
        const calldatas = [
            abiCoder.encode(["address"], [recoveryModule.address]),
            "0x",
        ...
        await governor
            .connect(proposer)
            .propose(targets, values, signatures, calldatas, "SIP-0095 rehearsal");
