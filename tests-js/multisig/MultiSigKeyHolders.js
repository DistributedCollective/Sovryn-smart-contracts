...
contract('MultiSigKeyHolders:', accounts => {
    ...
    describe("addEthereumAddress", () => {
        ...
        it("Shouldn't be able to add zero address", async () => {
            await expectRevert(multiSig.addEthereumAddress(ZERO_ADDRESS),
                "Invalid address");
        });

        it("Only owner should be able to add address", async () => {
            await expectRevert(multiSig.addEthereumAddress(account1, {from: account1}),
                "unauthorized");
        });
    ...
    describe("addEthereumAddresses", () => {
        ...
        it("Shouldn't be able to add zero addresses", async () => {
            await expectRevert(multiSig.addEthereumAddresses([ZERO_ADDRESS]),
                "Invalid address");
        });

        it("Only owner should be able to add addresses", async () => {
            await expectRevert(multiSig.addEthereumAddresses([account1, account2], {from: account1}),
                "unauthorized");
        });
    ...
    describe("addBitcoinAddress", () => {
        ...
        it("Shouldn't be able to add zero address", async () => {
            await expectRevert(multiSig.addBitcoinAddress(EMPTY_ADDRESS),
                "Invalid address");
        });

        it("Only owner should be able to add address", async () => {
            await expectRevert(multiSig.addBitcoinAddress(bitcoinAccount1, {from: account1}),
                "unauthorized");
        });
    ...
    describe("addBitcoinAddresses", () => {
        ...
        it("Shouldn't be able to add zero addresses", async () => {
            await expectRevert(multiSig.addBitcoinAddresses([EMPTY_ADDRESS]),
                "Invalid address");
        });

        it("Only owner should be able to add addresses", async () => {
            await expectRevert(multiSig.addBitcoinAddresses([bitcoinAccount1, bitcoinAccount2], {from: account1}),
                "unauthorized");
        });
    ...
    describe("addEthereumAndBitcoinAddresses", () => {
        ...
        it("Shouldn't be able to add zero address", async () => {
            await expectRevert(multiSig.addEthereumAndBitcoinAddresses([ZERO_ADDRESS], [bitcoinAccount1]),
                "Invalid address");
        });

        it("Only owner should be able to add address", async () => {
            await expectRevert(multiSig.addEthereumAndBitcoinAddresses([account1, account2], [bitcoinAccount1, bitcoinAccount2], {from: account1}),
                "unauthorized");
        });
