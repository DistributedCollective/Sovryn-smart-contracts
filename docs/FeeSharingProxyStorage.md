# FeeSharingProxy Storage contact. (FeeSharingProxyStorage.sol)
...
**↘ Derived Contracts: [FeeSharingLogic](FeeSharingLogic.md), [FeeSharingProxy](FeeSharingProxy.md), [ILoanToken](ILoanToken.md), [ILoanTokenWRBTC](ILoanTokenWRBTC.md)**

**FeeSharingProxyStorage**
...
- [underlyingToLoanPool(address token)](#underlyingtoloanpool)
