...
/// @notice Configurable stub controller for the ColFee tests in this repo. Tests
...
///         controller's job and is covered by the colfee Foundry suite.
contract MockExitFeeController is IExitFeeController {
    ...
    // Actor override (top tier of the colfee controller's resolution order).
