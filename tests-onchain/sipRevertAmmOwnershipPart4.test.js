...
// now run the test:
//     npx hardhat test tests-onchain/sipRevertAmmOwnershipPart4.test.js --network rskForkedMainnet
...
describe("Revert AMM Ownership Part 4 (GovernorOwner) - Inverse of SIP-0046 Part 4", () => {
    ...
    describe("SIP Revert AMM Ownership Part 4 - Test creation and execution", () => {
        it("SIP Revert AMM Ownership Part 4 is executable and valid", async () => {
            ...
            await hre.run("sips:create", { argsFunc: "getArgsSipRevertAmmOwnershipPart4" });
