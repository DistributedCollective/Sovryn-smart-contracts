...
// now run the test:
//     npx hardhat test tests-onchain/sipRevertAmmOwnershipPart2.test.js --network rskForkedMainnet
...
const { getAmmOracleAddress } = require("../hardhat/helpers");
...
describe("Revert AMM Ownership Part 2 (GovernorAdmin) - Inverse of SIP-0046 Part 2", () => {
    ...
    describe("SIP Revert AMM Ownership Part 2 - Test creation and execution", () => {
        it("SIP Revert AMM Ownership Part 2 is executable and valid", async () => {
            ...
            await hre.run("sips:create", { argsFunc: "getArgsSipRevertAmmOwnershipPart2" });
