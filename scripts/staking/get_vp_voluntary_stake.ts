...
async function getTotalVoluntaryVotingPower(addresses: StakingAddresses): Promise<{
...
async function main() {
    ...
    const addresses: StakingAddresses = {
        ...
        rsk_staker: splittedAddresses.length == 1 ? splittedAddresses[0] : splittedAddresses[1]
    };
