...
def createProposalSIP0020():
    ...
    staking = Contract.from_abi("StakingProxy", address=contracts['Staking'], abi=StakingProxy.abi, owner=acct)
    stakingLogic = Contract.from_abi("StakingLogic3", address=contracts['StakingLogic3'], abi=interface.IStakingModules.abi, owner=acct)
...
def createProposalSIP0030():
    ...
    stakingImpl = Contract.from_abi("Staking", address=contracts['Staking'], abi=interface.IStakingModules.abi, owner=acct)
...
def createProposalSIP0042():
    ...
    staking = Contract.from_abi("StakingProxy", address=contracts['Staking'], abi=StakingProxy.abi, owner=acct)
    stakingLogic = Contract.from_abi("StakingLogic5", address=contracts['StakingLogic5'], abi=interface.IStakingModules.abi, owner=acct)
