...
contract ProtocolSettingsMockup is ProtocolSettings {
    ...
    function setLendingFeeTokensHeld(address token, uint amout) public {
        lendingFeeTokensHeld[token] = amout;
    }
    
    function setTradingFeeTokensHeld(address token, uint amout) public {
        tradingFeeTokensHeld[token] = amout;
    }
    
    function setBorrowingFeeTokensHeld(address token, uint amout) public {
