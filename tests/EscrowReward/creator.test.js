...
contract("Escrow Rewards (Creator Functions)", (accounts) => {
    ...
    it("Creator should not be able to create Escrow Contract without specifying the sov contract.", async () => {
        // Creating the contract instance.
        await expectRevert(
            EscrowReward.new(lockedSOV.address, zeroAddress, multisig, zero, depositLimit, {
                from: creator,
            }),
            "Invalid SOV Address."
        );
    ...
    it("Creator should not be able to create Escrow Contract without specifying the Multisig.", async () => {
        // Creating the contract instance.
        await expectRevert(
            EscrowReward.new(lockedSOV.address, sov.address, zeroAddress, zero, depositLimit, {
                from: creator,
            }),
    ...
    it("Creator should not be able to update the Multisig.", async () => {
        await expectRevert(
            escrowReward.updateMultisig(newMultisig, { from: creator }),
    ...
    it("Creator should not be able to update the release time.", async () => {
        await expectRevert(
            escrowReward.updateReleaseTimestamp(currentTimestamp(), { from: creator }),
            "Only Multisig can call this."
        );
    });
    ...
    it("Creator should not be able to update the deposit limit.", async () => {
        await expectRevert(
            escrowReward.updateDepositLimit(zero, { from: creator }),
            "Only Multisig can call this."
        );
    });
    ...
    it("Creator could not deposit Tokens during any other State other than Deposit.", async () => {
        ...
        await expectRevert(
            escrowReward.depositTokens(value, { from: creator }),
    ...
    it("Creator should not be able to change the contract to Holding State.", async () => {
        await expectRevert(
            escrowReward.changeStateToHolding({ from: creator }),
            "Only Multisig can call this."
        );
    });
    ...
    it("Creator should not be able to withdraw all token to safeVault.", async () => {
        await expectRevert(
            escrowReward.withdrawTokensByMultisig(safeVault, { from: creator }),
            "Only Multisig can call this."
        );
    });
    ...
    it("Creator should not be able to deposit tokens using depositTokensByMultisig.", async () => {
        await expectRevert(
            escrowReward.depositTokensByMultisig(zero, { from: creator }),
            "Only Multisig can call this."
        );
    });
    ...
    it("Creator should not be able to withdraw unless in the Withdraw State.", async () => {
        ...
        await expectRevert(
            escrowReward.withdrawTokensAndReward({ from: creator }),
            "The contract is not in the right state."
        );
    });
